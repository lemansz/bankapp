...
<body>
    ...
    <form method="post" action="send-passkey-reset.php" id="forgotPasskeyForm" novalidate>
        <label for="email">
...
const form = document.getElementById("forgotPasskeyForm");
